...
bool MassSolver::solve( const TVector2 & met, const TLorentzVector & bq1 , const TLorentzVector & bq2 , const TLorentzVector & lep1, const TLorentzVector & lep2, double mW1, double mW2, double mt1, double mt2, vector< TLorentzVector > & nu1, vector< TLorentzVector > & nu2 )
{
